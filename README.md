...
- `generated/` : Carpeta donde se generan Lexer, Parser y Visitor (Está incluida, pero si da algún error te recomiendo borrarla y volverla a hacer usando el comando npm install).
...
2. Instalar dependencias (Aunque ya deje incluido el archivo generated, Deberias borrar esa carpeta y volver a generarla con este comando, muy recomendado si hay algún problema. Siempre hay que acordarse de tener java instalado y actualizado en tu computadora para evitar cualquier problema):
